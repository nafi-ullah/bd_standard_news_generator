...
const Navbar = () => {
  ...
  <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    <a class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0" href='https://www.google.com'>
      ...
      <span class="ml-3 text-xl">BD Standard  <br/> News Generator  </span>
    </a>
    <nav class="md:ml-auto md:mr-auto flex flex-wrap items-center text-bold text-black justify-center">
